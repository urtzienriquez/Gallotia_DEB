...
par.E_G = [7784.7429 7849.68 7806.0649 7820.2939 7843.3714 7807.0741 7849.2823];      free.E_G   = [1 1 1 1 1 1 1];   units.E_G = 'J/cm^3';     label.E_G = '[E_G], spec cost for structure'; 
...
%% other parameters 
par.E_Hpm = [9.473e+04 2.016e+05 9.346e+03 1.875e+04 1.383e+05 1.797e+05 1.838e+05]; free.E_Hpm = [1 1 1 1 1 1 1];   units.E_Hpm = 'J';        label.E_Hpm = 'maturity at puberty for males'; 
...
par.f_tL_c = 0.26062;                                                                free.f_tL_c  = 1;               units.f_tL_c = '-';       label.f_tL_c = 'scaled functional response for tL data caesaris'; 
par.f_tL_g = 1.1919;                                                                 free.f_tL_g  = 1;               units.f_tL_g = '-';       label.f_tL_g = 'scaled functional response for tL data galloti'; 
